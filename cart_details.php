			...
			foreach($stmt as $row){
				...
				$output .= "
					<tr>
						...
						<td class='input-group' style='display:block;'>

            			
            				<input type='text' class='form-control' style='width:70px;' value='".$row['quantity']."' id='qty_".$row['cartid']."'>
				...
				$output .= "
					<tr>
						...
						<td class='input-group' style='display:block;'>
            				...
            				<input type='text' class='form-control' style='width:70px;' value='".$row['quantity']."' id='qty_".$row['productid']."'>
				            <span class='input-group-btn'>
